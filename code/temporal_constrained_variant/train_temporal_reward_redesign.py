...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/temporal_constrained_variant")
    parser.add_argument("--model-dir", type=str, default="models/temporal_constrained_variant")
