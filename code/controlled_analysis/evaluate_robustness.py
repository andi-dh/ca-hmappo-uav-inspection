...
from controlled_variant_env_wrapper import AblationMAPPOEnvWrapper
from train_controlled_variants import HeterogeneousActor  # noqa: F401 – needed for model
...
def main():
    ...
    parser.add_argument("--model-base", type=str,
                        default="models/training_seed_robustness")
    parser.add_argument("--output-dir", type=str,
                        default="outputs/training_seed_robustness/evaluation")
