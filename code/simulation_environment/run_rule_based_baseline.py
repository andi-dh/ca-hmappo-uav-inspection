...
def run_episode(
    scenario: int = 1,
    seed: int = 42,
    output_dir: str = "outputs/rule_based_baselines",
    ...
    metrics["seed"] = seed
    metrics["rule_based_baselines"] = baseline
    if save_artifacts:
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/rule_based_baselines")
