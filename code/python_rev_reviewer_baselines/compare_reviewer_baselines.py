...
def compare(args: argparse.Namespace) -> None:
    ...
    print("Reviewer baseline comparison saved")
    print(output_file)
    for row in rows:
        print(row)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Compare reviewer-requested baselines.")
    ...
    parser.add_argument("--rev-dir", type=str, default="outputs/rev_reviewer_baselines")
