...
for folder in ["homogeneous_mappo", "heterogeneous_mappo", "ca_hmappo", "simulation_environment"]:
    path = ROOT / folder
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model", type=str, default="models/ca_hmappo/capability_aware_mappo_scenario_1.pt")
