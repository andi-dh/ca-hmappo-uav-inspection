...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build 4B ablation comparison table.")
    parser.add_argument("--output-dir", type=str, default="outputs/4b_ablation")
    parser.add_argument("--full-mean-std", type=str, default="outputs/3c_capability_aware_mappo/scenario_1_capability_aware_mappo_sampling_mean_std.csv")
